...
:keywords: tutorial, kernel, barebones
...
This article will demonstrate how to write a small 64-bit higher-half stivale2 kernel in (GNU) C, and boot it using the xref:limine.adoc[] bootloader.

It is also recommended to check out https://github.com/limine-bootloader/limine-barebones[this] project as it provides example buildable code to go along with this tutorial.
